                        ...
                        <div class="md:w-1/2 flex flex-col">
                            ...
                            <div class="flex-grow relative">
                                <div id="company-photo" class="company-tab-content absolute inset-0">
                                    <img src="画像(26).jpg" alt="オフィス外観" class="w-full h-full object-cover"/>
                                </div>
